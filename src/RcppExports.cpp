...
RcppExport SEXP _simulationBands_crossdist(SEXP m1SEXP, SEXP m2SEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_simulationBands_crossdist", (DL_FUNC) &_simulationBands_crossdist, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_simulationBands(DllInfo *dll) {
